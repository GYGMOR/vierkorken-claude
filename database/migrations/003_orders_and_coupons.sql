-- Orders, Order Items, and Coupons System
-- Run this migration to enable order processing and coupon functionality
...
-- Order Number Sequence (for generating unique order numbers)
-- Format: VK-YYYYMMDD-XXXX (VK = Vier Korken, XXXX = daily sequence)
